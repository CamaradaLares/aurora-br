...
def extract_article(html_content, source=None):
...
if __name__ == "__main__":
    url_file_path = "unique_extracted_links-mst.txt"  # Replace with the path to your text file containing URLs
    urls = read_urls_from_file(url_file_path)
    output_folder = "cleaned_extracted_articles_mst"  # Output folder name
