...
def read_and_parse_html(file_path):
    ...
    h3_elements = soup.find_all('h3', {'class': 'entry-title td-module-title'})
    links = [h3.find('a', href=True)['href'] for h3 in h3_elements if h3.find('a', href=True)]
    return links
...
if __name__ == "__main__":
    ...
    output_file = "unique_extracted_links-revistaopera.txt"  # Output file name
