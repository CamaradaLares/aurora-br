...
# Function to process URLs with error handling and retries for specific error
def process_urls(urls, output_folder, max_retries=10):
...
if __name__ == "__main__":
    url_file_path = "unique_extracted_links-revistaopera.txt"  # Replace with the path to your text file containing URLs
    urls = read_urls_from_file(url_file_path)
    output_folder = "cleaned_extracted_articles_revistaopera"  # Output folder name
