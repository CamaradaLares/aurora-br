...
if __name__ == "__main__":
    url_file_path = "unique_extracted_links-averdade.txt"  # Replace with the path to your text file containing URLs
    urls = read_urls_from_file(url_file_path)
    output_folder = "cleaned_extracted_articles_averdade"  # Output folder name
